      ...
      <div style={UI.shell}>
        <div style={UI.header}>
          <div style={{display:'flex', alignItems:'center', gap:12}}>
            <img src="/beer/foam-1.jpg" alt="Öl" width={36} height={36} style={{borderRadius:10, objectFit:'cover'}} />
            <div>
      ...
      <div style={{width:'100%', maxWidth:640, background:'#fff', border:'1px solid #e5e7eb', borderRadius:16, padding:16}}>
        ...
        <div style={{display:'grid', gap:10}}>
          ...
          <div>
            ...
            <div style={{fontSize:12, color:'#6b7280'}}>Tips: du kan dra & släppa en bild här. Vi nedsamplar i backend.</div>
          </div>
        </div>
